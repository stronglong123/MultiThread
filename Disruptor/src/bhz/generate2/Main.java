...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        // EventHandlerGroup<Trade> handlerGroup = disruptor
         ...
         * Handler5(); disruptor.handleEventsWith(h1, h2);
         * disruptor.after(h1).handleEventsWith(h4);
         * disruptor.after(h2).handleEventsWith(h5); disruptor.after(h4,
         * h5).handleEventsWith(h3);
         */
