...
public class LongEventMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 第二个参数是缓冲区大小
        // 第三个参数线程池，进行disruptor 内部的数据接受处理调度
        // 第四个参数ProducerType.SINGLE ProducerType.MULTI 设置生产者是一个还是多个
        // 最后一个参数是一种策略，WaitStrategy
        ...
        LongEventProducerWithTranslator producer = new LongEventProducerWithTranslator(
                ringBuffer);
